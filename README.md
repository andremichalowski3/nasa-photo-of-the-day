...
This project was put together using create-react-app (CRA). You will not need to install CRA in order to make this prcoject work. Follow the steps below to setup the project with the proper dependencies.
